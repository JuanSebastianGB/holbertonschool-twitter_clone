...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<String> uploadImage(PlatformFile? picket) async {
    ...
    final snapshot = await uploadTask!.whenComplete(() {
      debugPrint(
          'inside when completed name controller: ${_nameController.text}');
    });
    debugPrint('inside name controller: ${_nameController.text}');
  ...
  Future saveChanges() async {
    ...
    try {
      final String coverImgUrl = pickedCoverImg != null
          ? await uploadImage(pickedCoverImg)
          : data.coverImgUrl;
      final String imageUrl = pickedProfileImg != null
          ? await uploadImage(pickedProfileImg)
          : data.imageUrl;
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          _userNameController.text = _userNameController.text != '' &&
              ...
              : data.userName;
          _bioController.text =
              _bioController.text != '' && _bioController.text != data.bio
                  ? _bioController.text
                  : data.bio;
          return Scaffold(
            appBar: AppBar(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: pickedCoverImg != null
                            ? Image.file(File(pickedCoverImg!.path!),
